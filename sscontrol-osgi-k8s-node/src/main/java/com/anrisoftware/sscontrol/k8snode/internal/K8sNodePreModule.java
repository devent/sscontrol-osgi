...
/**
 * <i>K8s-Node</i> pre-script module.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
public class K8sNodePreModule extends AbstractModule {

    @Override
    protected void configure() {
        install(new FactoryModuleBuilder()
                .implement(PreHost.class, K8sNodePreScriptImpl.class)
                .build(K8sNodePreScriptImplFactory.class));
    }
