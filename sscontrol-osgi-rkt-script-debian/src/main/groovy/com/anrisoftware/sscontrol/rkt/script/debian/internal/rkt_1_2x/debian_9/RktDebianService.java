...
public class RktDebianService implements HostServiceScriptService {
    ...
    @Inject
    private RktDebianFactory scriptFactory;
    ...
    protected void start() {
        createInjector(new RktDebianModule()).injectMembers(this);
    }
