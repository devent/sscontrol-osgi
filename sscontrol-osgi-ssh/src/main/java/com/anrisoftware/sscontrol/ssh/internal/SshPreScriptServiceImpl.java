 ...
 */
@Component
@Service(SshPreScriptService.class)
public class SshPreScriptServiceImpl implements SshPreScriptService {
    ...
    protected void start() {
        Guice.createInjector(new SshPreModule(), new AbstractModule() {
