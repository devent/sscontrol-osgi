...
public class Shell_Linux_Service implements HostServiceScriptService {
    ...
    @Inject
    private Shell_Linux_Factory hostsFactory;
    ...
    protected void start() {
        createInjector(new Shell_Linux_Module()).injectMembers(this);
    }
