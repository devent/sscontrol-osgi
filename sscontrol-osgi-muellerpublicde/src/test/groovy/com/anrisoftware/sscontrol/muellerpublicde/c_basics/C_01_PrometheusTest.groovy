...
service "from-helm", chart: "stable/prometheus-operator", version: "5.5.1" with {
    release ns: "robobeerun-com-prometheus-operator", name: "robobeerun-com-prometheus-operator"
    config << """
alertmanager:
  ingress:
    enabled: true
    hosts:
      - alertmanager.andrea.muellerpublic.de
