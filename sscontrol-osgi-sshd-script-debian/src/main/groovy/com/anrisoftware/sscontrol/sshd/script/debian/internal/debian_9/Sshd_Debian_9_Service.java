...
public class Sshd_Debian_9_Service implements HostServiceScriptService {
    ...
    @Inject
    private Sshd_Debian_9_Factory scriptFactory;
    ...
    protected void start() {
        createInjector(new Sshd_Debian_9_Module()).injectMembers(this);
    }
