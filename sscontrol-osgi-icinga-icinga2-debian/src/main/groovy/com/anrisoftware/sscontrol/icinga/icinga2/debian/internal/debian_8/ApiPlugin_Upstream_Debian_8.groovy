...
/**
 * Installs the api plugin from the upstream repository for Debian 8.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
@Slf4j
class ApiPlugin_Upstream_Debian_8 extends AbstractPlugin_Upstream_Debian_8 {

    def installPlugin(Plugin plugin) {
    }

    def configurePlugin(Plugin plugin) {
        super.configurePlugin plugin
