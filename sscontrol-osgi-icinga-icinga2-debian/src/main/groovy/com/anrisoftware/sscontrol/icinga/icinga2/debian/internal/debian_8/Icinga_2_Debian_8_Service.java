...
public class Icinga_2_Debian_8_Service implements HostServiceScriptService {
    ...
    @Inject
    private Icinga_2_Debian_8_Factory scriptFactory;
    ...
    protected void start() {
        createInjector(new Icinga_2_Debian_8_Module()).injectMembers(this);
    }
