...
public class IcingaDebianService implements HostServiceScriptService {
    ...
    @Inject
    private IcingaDebianFactory scriptFactory;
    ...
    protected void start() {
        createInjector(new IcingaDebianModule()).injectMembers(this);
    }
