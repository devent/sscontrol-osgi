 ...
 */
@Slf4j
class FromRepositoryDockerServerTest extends AbstractGlusterfsHeketiRunnerTest {
...
''',
            ...
            before: { Map test -> setupServer test: test, zipArchive: AbstractGlusterfsHeketiRunnerTest.wordpressZip },
