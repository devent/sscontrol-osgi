 ...
 * @since 1.0
 */
@Component(service = { ShellService.class, OpenSshShellService.class })
public class ShellServiceImpl implements ShellService, OpenSshShellService {
    ...
    @Override
    public Shell create(Map<String, Object> args, @Assisted SshHost ssh, Object parent, Threads threads, Object log) {
