...
/**
 * Configures the <i>Flannel-Docker</i> 0.8 service from the upstream sources.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
@Slf4j
abstract class FlannelDocker_0_8_Upstream extends ScriptBase {

    TemplateResource installCmdResource

    @Inject
    def setTemplates(TemplatesFactory factory) {
        def t = factory.create 'FlannelDocker_0_8_Upstream_Templates'
