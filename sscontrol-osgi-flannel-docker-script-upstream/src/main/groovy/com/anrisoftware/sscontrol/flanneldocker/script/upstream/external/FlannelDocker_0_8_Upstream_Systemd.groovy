/*-
 * #%L
 * sscontrol-osgi - flannel-docker-script-upstream
 * %%
...
/**
 * Configures the <i>Flannel-Docker</i> 0.8 service from the upstream
 * sources for Systemd.
 *
 ...
 */
@Slf4j
abstract class FlannelDocker_0_8_Upstream_Systemd extends ScriptBase {
    ...
    void loadTemplates(TemplatesFactory templatesFactory, NetworkRenderer networkRenderer) {
        ...
        def t = templatesFactory.create('FlannelDocker_0_8_Upstream_Systemd_Templates', attrs)
