 ...
 * {@code "/from_repository_1_13_linux.properties"}.
 *
...
class FromRepositoryLinuxProperties extends AbstractContextPropertiesProvider {
    ...
    private static final URL RESOURCE = FromRepositoryLinuxProperties.class.getResource("/from_repository_1_13_linux.properties")
