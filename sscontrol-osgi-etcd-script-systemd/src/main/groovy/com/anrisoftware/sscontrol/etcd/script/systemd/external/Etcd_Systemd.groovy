 ...
 */
package com.anrisoftware.sscontrol.etcd.script.systemd.external
...
/**
 * Configures the Etcd service using Systemd.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
@Slf4j
abstract class Etcd_Systemd extends ScriptBase {
