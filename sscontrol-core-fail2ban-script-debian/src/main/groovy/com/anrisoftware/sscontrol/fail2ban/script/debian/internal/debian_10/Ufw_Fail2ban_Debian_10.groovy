...
import com.anrisoftware.sscontrol.fail2ban.script.debian.internal.debian.Ufw_Fail2ban_0_10_Debian
 ...
 * @version 1.0
 */
class Ufw_Fail2ban_Debian_10 extends Ufw_Fail2ban_0_10_Debian {

    @Inject
    Ufw_Fail2ban_Debian_10_Properties debianPropertiesProvider
    ...
    def configureActions() {
        def t = templatesFactory.create 'Ufw_Fail2ban_Debian_10_Templates'
