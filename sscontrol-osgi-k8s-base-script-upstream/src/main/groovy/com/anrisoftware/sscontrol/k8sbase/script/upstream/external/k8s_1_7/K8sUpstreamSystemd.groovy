...
/**
 * Configures the K8s service from the upstream sources for Systemd.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
@Slf4j
abstract class K8sUpstreamSystemd extends ScriptBase {
...
systemctl daemon-reload
     ...
     */
    abstract KubectlClusterLinux getKubectlCluster()
