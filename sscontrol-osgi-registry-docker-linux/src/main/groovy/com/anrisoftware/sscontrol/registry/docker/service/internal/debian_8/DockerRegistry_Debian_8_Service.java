...
public class DockerRegistry_Debian_8_Service implements HostServiceScriptService {
    ...
    @Inject
    private DockerRegistry_Debian_8_Factory scriptFactory;
    ...
    protected void start() {
        createInjector(new DockerRegistry_Debian_8_Module()).injectMembers(this);
    }
